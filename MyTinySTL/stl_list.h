...
struct _List_iterator :public _List_iterator_base {
    ...
    //inline bidirectional_iterator_tag iterator_category(const _List_Iterator_base&){
...
public:
    ...
    inline void push_front(const _Tp& __x) {
        insert(begin(), __x);
    }
    ...
    inline void push_back(const _Tp& __x) {
        insert(end(), __x);
    }
    ...
    list(const _Tp* __first, const _Tp* __last, const allocator_type& __a = allocator_type())
        :_Base(__a)
    {
...
protected:
    ...
    void transfer(iterator __position, iterator __first, iterator __last) {
        if (__position != __last) {
            //remove [first, last) from old pos
            __last._M_node->_M_prev->_M_next = __position._M_node;
            __first._M_node->_M_prev->_M_next = __last._M_node;
            __position._M_node->_M_prev->_M_next = __first._M_node;

            //place [first, last) into new __position
...
operator==(const list<_Tp, _Alloc>& __lhs, const list<_Tp, _Alloc>& __rhs) {
    ...
    const_iterator __end1 = __lhs.end();
    const_iterator __end2 = __rhs.end();

    const_iterator __i1 = __lhs.begin();
    const_iterator __i2 = __rhs.begin();
...
inline bool
operator<(const list<_Tp, _Alloc>& __lhs, const list<_Tp, _Alloc>& __rhs) {
    return lexicographical_comapre(__lhs.begin(), __lhs.end(), __rhs.begin(), __rhs.end());
}
...
//template<class _Tp, class _Alloc>
//typename list<_Tp,_Alloc>::iterator list<_Tp, _Allic>::erase(iterator __first, iterator __last){
//    while(__first != __last){
//        erase(__first++);
//        
//    }
...
//template<class _Tp, class _Alloc>
//void list<_Tp,_Alloc>::operator=(const list<_Tp, _Alloc>& __x){
//    if(this != &__x){
//        iterator __first1 = begin();
//        iterator __last1 = end();
//        const_iterator __first2 = __x.begin();
...
//template<class _Tp, class _Alloc>
//void list<_Tp,_Alloc>::_M_fill_assign(size_type __n, const Tp& __val){
//    iterator __i = begin();
//    for(; __i != end() && __n > 0; ++__i, --__n){
//        *__i = __val;
//    }
